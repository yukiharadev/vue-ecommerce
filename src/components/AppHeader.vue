<template>
  <div class="bg-black text-white">
    <div class="container text-center mx-auto py-1 text-xs">
      ...
      <span class="underline font-bold cursor-pointer">Sign Up Now</span>
    </div>
  </div>
  <div class="bg-white">
    <fwb-navbar class="container max-w-7xl mx-auto">
      <template #logo>
        <RouterLink to="/" class="font-bold font-mono text-xl"
          >YukiharaShop</RouterLink
        >
      </template>
      <template #default="{ isShowMenu }">
        <fwb-navbar-collapse :is-show-menu="isShowMenu">
          ...
          <RouterLink class="fwb-navbar-link" to="/services">
            On Sale
          </RouterLink>
          <RouterLink class="fwb-navbar-link" to="/pricing">
            New Arrivals
          </RouterLink>
          <RouterLink class="fwb-navbar-link" to="/contact"> Brand </RouterLink>
        </fwb-navbar-collapse>
      </template>
      <template #right-side>
        <fwb-input
